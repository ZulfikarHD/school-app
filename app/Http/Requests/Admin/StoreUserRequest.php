...
class StoreUserRequest extends FormRequest
{
     ...
     * yang dapat membuat user account baru
     */
    ...
    /**
     * Validation rules untuk pembuatan user baru dengan field yang required
     * sesuai dengan business logic dan database schema
     *
