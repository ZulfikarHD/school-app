...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'status_keluarga' => ['required', Rule::in(['Anak Kandung', 'Anak Tiri', 'Anak Angkat'])],
            ...
            'ayah.pendidikan' => ['required', Rule::in(['SD', 'SMP', 'SMA', 'D3', 'S1', 'S2', 'S3'])],
            'ayah.penghasilan' => ['required', Rule::in(['<1jt', '1-3jt', '3-5jt', '>5jt'])],
            ...
            'ibu.pendidikan' => ['required', Rule::in(['SD', 'SMP', 'SMA', 'D3', 'S1', 'S2', 'S3'])],
            'ibu.penghasilan' => ['required', Rule::in(['<1jt', '1-3jt', '3-5jt', '>5jt'])],
            ...
            'wali.pendidikan' => ['nullable', Rule::in(['SD', 'SMP', 'SMA', 'D3', 'S1', 'S2', 'S3'])],
            'wali.penghasilan' => ['nullable', Rule::in(['<1jt', '1-3jt', '3-5jt', '>5jt'])],
