...
/**
 * Form Request untuk validasi update kategori pembayaran
 *
 * Memastikan data kategori pembayaran valid sebelum diupdate ke database
 */
class UpdatePaymentCategoryRequest extends FormRequest
{
     ...
     * yang dapat mengupdate kategori pembayaran
     */
    ...
    /**
     * Validation rules untuk update kategori pembayaran
     *
     * @return array<string, \Illuminate\Contracts\Validation\ValidationRule|array<mixed>|string>
     */
    public function rules(): array
    {
        $categoryId = $this->route('payment_category')?->id ?? $this->route('payment_category');
        ...
        return [
            ...
            'kode' => [
                ...
                'max:20',
                'alpha_dash',
                Rule::unique('payment_categories', 'kode')->ignore($categoryId),
            ],
