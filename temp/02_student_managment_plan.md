...
- `resources/js/components/ui/PhotoUpload.vue`
- `resources/js/components/ui/BulkPromotionWizard.vue`
- `resources/js/components/ui/ImportPreviewTable.vue`
- `resources/js/components/ui/ChildCard.vue`
