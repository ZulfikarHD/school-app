...
/**
 * Teachers Create Page - Halaman pembuatan guru baru
 * dengan form lengkap untuk biodata, kepegawaian, dan mata pelajaran
 */
...
import { index as teachersIndex, store as storeTeacher } from '@/routes/admin/teachers';
...
const submit = () => {
    haptics.medium();
    form.post(storeTeacher().url, {
        onSuccess: () => {
            haptics.success();
            modal.success('Data guru berhasil disimpan.');
        },
        onError: () => {
            haptics.heavy();
                    ...
                    <div class="flex items-center gap-3 sm:gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
                                Lengkapi formulir untuk menambahkan data guru baru
                            </p>
                        </div>
                    </div>
                </div>
