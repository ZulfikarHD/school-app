...
/**
 * Principal Financial Reports Page
 *
...
import { reports, delinquents } from '@/routes/principal/financial';
import { exportMethod as exportReport } from '@/routes/principal/financial/reports';
        ...
        <div class="max-w-7xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div class="bg-white dark:bg-zinc-900 rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 dark:border-zinc-800">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button
                                @click="handleExport"
                                class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-emerald-500 rounded-xl hover:bg-emerald-600 transition-colors shadow-lg shadow-emerald-500/25"
                            >
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        @change="applyFilters"
                                        class="w-full px-3 py-2 rounded-xl border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                                    >
            ...
            >
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <!-- Total Pendapatan -->
                    <div class="bg-linear-to-br from-emerald-500 to-emerald-600 rounded-2xl p-5 text-white shadow-lg shadow-emerald-500/25">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-emerald-100 text-sm">Total Pendapatan</p>
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-sm border border-slate-200 dark:border-zinc-800">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="w-10 h-10 rounded-lg bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center">
                                <PieChart class="w-5 h-5 text-violet-600 dark:text-violet-400" />
                            </div>
                        </div>
                    </div>
                            ...
                            >
                                <div class="w-full flex-1 flex items-end">
                                    <div
                                        ...
                                        class="w-full bg-emerald-500 dark:bg-emerald-400 rounded-t-lg min-h-[4px] transition-all duration-500"
            ...
            >
                <div class="bg-white dark:bg-zinc-900 rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 dark:border-zinc-800">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <button
                            @click="handleExport"
                            class="flex items-center gap-4 p-4 rounded-xl border border-slate-200 dark:border-zinc-800 hover:border-emerald-200 dark:hover:border-emerald-800 hover:bg-emerald-50 dark:hover:bg-emerald-900/10 transition-colors text-left"
                        >
                            <div class="w-12 h-12 rounded-xl bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center">
                                <Download class="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="font-medium text-slate-900 dark:text-slate-100">
                                    Export Laporan
