...
import { index as studentsIndex, show as showStudent } from '@/routes/teacher/students';
...
// Methods - Teacher hanya bisa view (read-only)
...
<template>
    <AppLayout title="Data Siswa Kelas Saya">
        ...
        <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-zinc-800">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h1 class="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-100 mb-1">
                                    Data Siswa Kelas Saya
                                </h1>
                                <p class="text-slate-600 dark:text-slate-400 text-sm">
                                    Lihat data siswa di kelas yang Anda ajar
                                </p>
                            </div>
                        </div>
            ...
            >
                <StudentTable
                    ...
                    empty-message="Tidak ada siswa di kelas yang Anda ajar"
                    @view="handleView"
                />
            </Motion>
        </div>
