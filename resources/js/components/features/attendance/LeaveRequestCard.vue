    ...
    >
        <div class="bg-white dark:bg-zinc-900 rounded-2xl border border-slate-200 dark:border-zinc-800 shadow-sm overflow-hidden">
            <div class="p-6 space-y-4">
                ...
                <div v-if="leaveRequest.status === 'PENDING'" class="flex gap-3 pt-2">
                    ...
                    <Motion :whileTap="{ scale: 0.97 }" class="flex-1">
                        <button
                            ...
                            :disabled="loading"
                            class="w-full px-4 py-2.5 bg-red-50 hover:bg-red-100 text-red-600 rounded-xl font-semibold
                ...
                >
                    <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-md w-full p-6 space-y-4">
                        ...
                        <div class="flex gap-3">
                            <button
                                @click="showRejectModal = false"
                                class="flex-1 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-700
                            ...
                            <button
                                ...
                                class="flex-1 px-4 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-xl font-semibold
                                       flex items-center justify-center gap-2
                                       disabled:opacity-50 disabled:cursor-not-allowed
                                       transition-colors duration-150"
                            >
